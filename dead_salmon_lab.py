...
def cell_hero():
    ...
    ">
        ...
        <h1 style="font-size: 2.8em; font-weight: 800; margin: 0;
                   background: linear-gradient(90deg, #FA8072, #FFD700);
                   -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
            The Dead Salmons of AI Interpretability
        </h1>
        <p style="font-size: 1.25em; opacity: 0.85; margin-top: 16px; max-width: 800px; margin-left: auto; margin-right: auto;">
            An interactive reproduction of <em>"The Dead Salmons of AI Interpretability"</em>
        ...
        <div style="margin-top: 28px; display: flex; justify-content: center; gap: 24px; flex-wrap: wrap;">
            <span style="background: rgba(250,128,114,0.2); border: 1px solid #FA8072;
                         border-radius: 20px; padding: 6px 18px; font-size: 0.95em;">
                📊 Reproduces Figure 4 (A, B, C)
            </span>
            <span style="background: rgba(76,120,168,0.2); border: 1px solid #4C78A8;
                         border-radius: 20px; padding: 6px 18px; font-size: 0.95em;">
                🎲 Interactive P-Hacking Simulator
            </span>
            <span style="background: rgba(84,162,75,0.2); border: 1px solid #54A24B;
                         border-radius: 20px; padding: 6px 18px; font-size: 0.95em;">
                🛡️ Live Hypothesis Testing (Eq. 4)
            </span>
            <span style="background: rgba(255,215,0,0.2); border: 1px solid #FFD700;
                         border-radius: 20px; padding: 6px 18px; font-size: 0.95em;">
                🧠 Full Statistical Framework (Table 1)
            </span>
        </div>
    </div>
    """)
